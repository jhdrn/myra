...
export function useMemo<TMemoization, TArgs>(fn: (args: TArgs) => TMemoization, inputs: TArgs) {
...
function renderComponent(parentElement: Element, newVNode: ComponentVNode<any>, isSvg: boolean) {
